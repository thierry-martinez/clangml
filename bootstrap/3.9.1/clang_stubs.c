...
Cxcursorkind_val(value ocaml)
{
  ...
  case 173: return CXCursor_TranslationUnit;
  case 174: return CXCursor_FirstAttr;
  case 175: return CXCursor_IBActionAttr;
  case 176: return CXCursor_IBOutletAttr;
  case 177: return CXCursor_IBOutletCollectionAttr;
  case 178: return CXCursor_CXXFinalAttr;
  case 179: return CXCursor_CXXOverrideAttr;
  case 180: return CXCursor_AnnotateAttr;
  case 181: return CXCursor_AsmLabelAttr;
  case 182: return CXCursor_PackedAttr;
  case 183: return CXCursor_PureAttr;
  case 184: return CXCursor_ConstAttr;
  case 185: return CXCursor_NoDuplicateAttr;
  case 186: return CXCursor_CUDAConstantAttr;
  case 187: return CXCursor_CUDADeviceAttr;
  case 188: return CXCursor_CUDAGlobalAttr;
  case 189: return CXCursor_CUDAHostAttr;
  case 190: return CXCursor_CUDASharedAttr;
  case 191: return CXCursor_VisibilityAttr;
  case 192: return CXCursor_DLLExport;
  case 193: return CXCursor_DLLImport;
  case 194: return CXCursor_PreprocessingDirective;
  case 195: return CXCursor_MacroDefinition;
  case 196: return CXCursor_MacroExpansion;
  case 197: return CXCursor_InclusionDirective;
  case 198: return CXCursor_ModuleImportDecl;
  case 199: return CXCursor_TypeAliasTemplateDecl;
  case 200: return CXCursor_StaticAssert;
  case 201: return CXCursor_OverloadCandidate;
  }
...
Val_cxcursorkind(enum CXCursorKind v)
{
  ...
  case CXCursor_TranslationUnit: return Val_int(173);
  case CXCursor_FirstAttr: return Val_int(174);
  case CXCursor_IBActionAttr: return Val_int(175);
  case CXCursor_IBOutletAttr: return Val_int(176);
  case CXCursor_IBOutletCollectionAttr: return Val_int(177);
  case CXCursor_CXXFinalAttr: return Val_int(178);
  case CXCursor_CXXOverrideAttr: return Val_int(179);
  case CXCursor_AnnotateAttr: return Val_int(180);
  case CXCursor_AsmLabelAttr: return Val_int(181);
  case CXCursor_PackedAttr: return Val_int(182);
  case CXCursor_PureAttr: return Val_int(183);
  case CXCursor_ConstAttr: return Val_int(184);
  case CXCursor_NoDuplicateAttr: return Val_int(185);
  case CXCursor_CUDAConstantAttr: return Val_int(186);
  case CXCursor_CUDADeviceAttr: return Val_int(187);
  case CXCursor_CUDAGlobalAttr: return Val_int(188);
  case CXCursor_CUDAHostAttr: return Val_int(189);
  case CXCursor_CUDASharedAttr: return Val_int(190);
  case CXCursor_VisibilityAttr: return Val_int(191);
  case CXCursor_DLLExport: return Val_int(192);
  case CXCursor_DLLImport: return Val_int(193);
  case CXCursor_PreprocessingDirective: return Val_int(194);
  case CXCursor_MacroDefinition: return Val_int(195);
  case CXCursor_MacroExpansion: return Val_int(196);
  case CXCursor_InclusionDirective: return Val_int(197);
  case CXCursor_ModuleImportDecl: return Val_int(198);
  case CXCursor_TypeAliasTemplateDecl: return Val_int(199);
  case CXCursor_StaticAssert: return Val_int(200);
  case CXCursor_OverloadCandidate: return Val_int(201);
  }
...
Cxcallingconv_val(value ocaml)
{
  ...
  case 12: return CXCallingConv_Swift;
  case 13: return CXCallingConv_PreserveMost;
  case 14: return CXCallingConv_PreserveAll;
  case 15: return CXCallingConv_Invalid;
  case 16: return CXCallingConv_Unexposed;
  }
...
Val_cxcallingconv(enum CXCallingConv v)
{
  ...
  case CXCallingConv_Swift: return Val_int(12);
  case CXCallingConv_PreserveMost: return Val_int(13);
  case CXCallingConv_PreserveAll: return Val_int(14);
  case CXCallingConv_Invalid: return Val_int(15);
  case CXCallingConv_Unexposed: return Val_int(16);
  }
