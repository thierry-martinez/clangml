...
Cxcursorkind_val(value ocaml)
{
  ...
  case 104: return CXCursor_FirstStmt;
  ...
  case 185: return CXCursor_FirstAttr;
...
Val_cxcursorkind(enum CXCursorKind v)
{
  ...
  case CXCursor_FirstStmt: return Val_int(104);
  ...
  case CXCursor_FirstAttr: return Val_int(185);
...
CAMLprim value
clang_PrintingPolicy_dispose_wrapper(value Policy_ocaml)
{
  CAMLparam1(Policy_ocaml);
  CXPrintingPolicy Policy;
  Policy = Cxprintingpolicy_val(Policy_ocaml);
