...
external printing_policy_dispose :
  cxprintingpolicy -> unit = "clang_PrintingPolicy_dispose_wrapper"
...
external cursor_get_obj_cmanglings :
  cxcursor -> cxstringset2 = "clang_Cursor_getObjCManglings_wrapper"
type cxmodule
...
type cxtoken2
external get_token :
  cxtranslationunit -> cxsourcelocation -> cxtoken2 =
    "clang_getToken_wrapper"
type cxtokenkind =
  | Punctuation 
  | Keyword 
  | Identifier 
