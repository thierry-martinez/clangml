...
Cxcursorkind_val(value ocaml)
{
  ...
  case 205: return CXCursor_NSReturnsRetained;
  case 206: return CXCursor_NSReturnsNotRetained;
  case 207: return CXCursor_NSReturnsAutoreleased;
  case 208: return CXCursor_NSConsumesSelf;
  case 209: return CXCursor_NSConsumed;
  case 210: return CXCursor_ObjCException;
  case 211: return CXCursor_ObjCNSObject;
  case 212: return CXCursor_ObjCIndependentClass;
  case 213: return CXCursor_ObjCPreciseLifetime;
  case 214: return CXCursor_ObjCReturnsInnerPointer;
  case 215: return CXCursor_ObjCRequiresSuper;
  case 216: return CXCursor_ObjCRootClass;
  case 217: return CXCursor_ObjCSubclassingRestricted;
  case 218: return CXCursor_ObjCExplicitProtocolImpl;
  case 219: return CXCursor_ObjCDesignatedInitializer;
  case 220: return CXCursor_ObjCRuntimeVisible;
  case 221: return CXCursor_ObjCBoxable;
  case 222: return CXCursor_FlagEnum;
  case 223: return CXCursor_PreprocessingDirective;
  case 224: return CXCursor_MacroDefinition;
  case 225: return CXCursor_MacroExpansion;
  case 226: return CXCursor_InclusionDirective;
  case 227: return CXCursor_ModuleImportDecl;
  case 228: return CXCursor_TypeAliasTemplateDecl;
  case 229: return CXCursor_StaticAssert;
  case 230: return CXCursor_FriendDecl;
  case 231: return CXCursor_OverloadCandidate;
  }
...
Val_cxcursorkind(enum CXCursorKind v)
{
  ...
  case CXCursor_NSReturnsRetained: return Val_int(205);
  case CXCursor_NSReturnsNotRetained: return Val_int(206);
  case CXCursor_NSReturnsAutoreleased: return Val_int(207);
  case CXCursor_NSConsumesSelf: return Val_int(208);
  case CXCursor_NSConsumed: return Val_int(209);
  case CXCursor_ObjCException: return Val_int(210);
  case CXCursor_ObjCNSObject: return Val_int(211);
  case CXCursor_ObjCIndependentClass: return Val_int(212);
  case CXCursor_ObjCPreciseLifetime: return Val_int(213);
  case CXCursor_ObjCReturnsInnerPointer: return Val_int(214);
  case CXCursor_ObjCRequiresSuper: return Val_int(215);
  case CXCursor_ObjCRootClass: return Val_int(216);
  case CXCursor_ObjCSubclassingRestricted: return Val_int(217);
  case CXCursor_ObjCExplicitProtocolImpl: return Val_int(218);
  case CXCursor_ObjCDesignatedInitializer: return Val_int(219);
  case CXCursor_ObjCRuntimeVisible: return Val_int(220);
  case CXCursor_ObjCBoxable: return Val_int(221);
  case CXCursor_FlagEnum: return Val_int(222);
  case CXCursor_PreprocessingDirective: return Val_int(223);
  case CXCursor_MacroDefinition: return Val_int(224);
  case CXCursor_MacroExpansion: return Val_int(225);
  case CXCursor_InclusionDirective: return Val_int(226);
  case CXCursor_ModuleImportDecl: return Val_int(227);
  case CXCursor_TypeAliasTemplateDecl: return Val_int(228);
  case CXCursor_StaticAssert: return Val_int(229);
  case CXCursor_FriendDecl: return Val_int(230);
  case CXCursor_OverloadCandidate: return Val_int(231);
  }
...
Cxtypekind_val(value ocaml)
{
  ...
  case 100: return CXType_ObjCObject;
  case 101: return CXType_ObjCTypeParam;
  case 102: return CXType_Attributed;
  case 103: return CXType_OCLIntelSubgroupAVCMcePayload;
  case 104: return CXType_OCLIntelSubgroupAVCImePayload;
  case 105: return CXType_OCLIntelSubgroupAVCRefPayload;
  case 106: return CXType_OCLIntelSubgroupAVCSicPayload;
  case 107: return CXType_OCLIntelSubgroupAVCMceResult;
  case 108: return CXType_OCLIntelSubgroupAVCImeResult;
  case 109: return CXType_OCLIntelSubgroupAVCRefResult;
  case 110: return CXType_OCLIntelSubgroupAVCSicResult;
  case 111: return CXType_OCLIntelSubgroupAVCImeResultSingleRefStreamout;
  case 112: return CXType_OCLIntelSubgroupAVCImeResultDualRefStreamout;
  case 113: return CXType_OCLIntelSubgroupAVCImeSingleRefStreamin;
  case 114: return CXType_OCLIntelSubgroupAVCImeDualRefStreamin;
  }
...
Val_cxtypekind(enum CXTypeKind v)
{
  ...
  case CXType_ObjCObject: return Val_int(100);
  case CXType_ObjCTypeParam: return Val_int(101);
  case CXType_Attributed: return Val_int(102);
  case CXType_OCLIntelSubgroupAVCMcePayload: return Val_int(103);
  case CXType_OCLIntelSubgroupAVCImePayload: return Val_int(104);
  case CXType_OCLIntelSubgroupAVCRefPayload: return Val_int(105);
  case CXType_OCLIntelSubgroupAVCSicPayload: return Val_int(106);
  case CXType_OCLIntelSubgroupAVCMceResult: return Val_int(107);
  case CXType_OCLIntelSubgroupAVCImeResult: return Val_int(108);
  case CXType_OCLIntelSubgroupAVCRefResult: return Val_int(109);
  case CXType_OCLIntelSubgroupAVCSicResult: return Val_int(110);
  case CXType_OCLIntelSubgroupAVCImeResultSingleRefStreamout: return Val_int(111);
  case CXType_OCLIntelSubgroupAVCImeResultDualRefStreamout: return Val_int(112);
  case CXType_OCLIntelSubgroupAVCImeSingleRefStreamin: return Val_int(113);
  case CXType_OCLIntelSubgroupAVCImeDualRefStreamin: return Val_int(114);
  }
