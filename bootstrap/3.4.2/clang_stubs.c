...
Clang_ext_stmtkind_val(value ocaml)
{
  ...
  case 135: return CLANG_EXT_STMT_Unknown;
  }
...
Val_clang_ext_stmtkind(enum clang_ext_StmtKind v)
{
  ...
  case CLANG_EXT_STMT_Unknown: return Val_int(135);
  }
...
Clang_ext_langstandards_val(value ocaml)
{
  ...
  case 31: return CLANG_EXT_LANGSTANDARDS_Invalid;
  }
...
Val_clang_ext_langstandards(enum clang_ext_langstandards v)
{
  ...
  case CLANG_EXT_LANGSTANDARDS_Invalid: return Val_int(31);
  }
