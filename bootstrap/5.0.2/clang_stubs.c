...
clang_isFileMultipleIncludeGuarded_wrapper(value tu_ocaml, value file_ocaml)
{
  ...
  tu = Cxtranslationunit_val(tu_ocaml);
  CXFile file;
...
clang_getPresumedLocation_wrapper(value location_ocaml)
{
  ...
  {
    CAMLlocal1(field);
    field = OCAML_OF_CXSTRING(filename);
    Store_field(data, 0, field);
  }
  {
    CAMLlocal1(field);
...
clang_loadDiagnostics_wrapper(value file_ocaml)
{
  ...
  {
    CAMLlocal1(field);
    field = OCAML_OF_CXSTRING(errorString);
    Store_field(data, 1, field);
  }
...
clang_getNumDiagnostics_wrapper(value Unit_ocaml)
{
  ...
  Unit = Cxtranslationunit_val(Unit_ocaml);
...
clang_getDiagnosticOption_wrapper(value Diag_ocaml)
{
  ...
  {
    CAMLlocal1(field);
    field = OCAML_OF_CXSTRING(result);
    Store_field(data, 0, field);
  }
  {
    CAMLlocal1(field);
    field = OCAML_OF_CXSTRING(Disable);
    Store_field(data, 1, field);
  }
...
clang_getTranslationUnitSpelling_wrapper(value CTUnit_ocaml)
{
  ...
  CTUnit = Cxtranslationunit_val(CTUnit_ocaml);
...
clang_createTranslationUnitFromSourceFile_wrapper(value CIdx_ocaml, value source_filename_ocaml, value clang_command_line_args_ocaml, value unsaved_files_ocaml)
{
  ...
  {
    CAMLlocal1(data);
    data = Val_cxtranslationunit(result);
    CAMLreturn(data);
  }
}
...
clang_createTranslationUnit2_wrapper(value CIdx_ocaml, value ast_filename_ocaml)
{
  ...
  if (result == CXError_Success) {
    CAMLlocal2(ocaml_result, data);
    ocaml_result = caml_alloc(1, 0);
    data = Val_cxtranslationunit(out_TU);
    Store_field(ocaml_result, 0, data);
    CAMLreturn(ocaml_result);
  }
  else {
...
DECLARE_OPAQUE(CXTargetInfo, cxtargetinfo, Cxtargetinfo_val, Val_cxtargetinfo)
...
CAMLprim value
clang_TargetInfo_dispose_wrapper(value Info_ocaml)
{
...
CAMLprim value
clang_getCursorPlatformAvailability_wrapper(value cursor_ocaml, value always_deprecated_ocaml, value deprecated_message_ocaml, value always_unavailable_ocaml, value unavailable_message_ocaml, value availability_ocaml, value availability_size_ocaml)
{
  CAMLparam5(cursor_ocaml, always_deprecated_ocaml, deprecated_message_ocaml, always_unavailable_ocaml, unavailable_message_ocaml);
  CAMLxparam2(availability_ocaml, availability_size_ocaml);
  CXCursor cursor;
  cursor = Cxcursor_val(cursor_ocaml);
  int * always_deprecated;
  always_deprecated = (always_deprecated_ocaml);
  CXString * deprecated_message;
  deprecated_message = (deprecated_message_ocaml);
  int * always_unavailable;
  always_unavailable = (always_unavailable_ocaml);
  CXString * unavailable_message;
  unavailable_message = (unavailable_message_ocaml);
  CXPlatformAvailability * availability;
  availability = (availability_ocaml);
  int availability_size;
  availability_size = Int_val(availability_size_ocaml);
  int result = clang_getCursorPlatformAvailability(cursor, always_deprecated, deprecated_message, always_unavailable, unavailable_message, availability, availability_size);
  {
    CAMLlocal1(data);
    data = Val_int(result);
    CAMLreturn(data);
...
CAMLprim value
clang_getCursorPlatformAvailability_bytecode(value *argv, int argn)
{
  return clang_getCursorPlatformAvailability_wrapper(argv[0], argv[1], argv[2], argv[3], argv[4], argv[5], argv[6]);}

CAMLprim value
clang_disposeCXPlatformAvailability_wrapper(value availability_ocaml)
{
  CAMLparam1(availability_ocaml);
  CXPlatformAvailability * availability;
  availability = (availability_ocaml);
...
for (unsigned int i = 0; i < num_overridden; i++) {
  CAMLlocal1(cell);
  cell = Val_cxcursor(overridden[i]);
...
Cxtypekind_val(value ocaml)
{
  ...
  case 32: return CXType_Complex;
  case 33: return CXType_Pointer;
  case 34: return CXType_BlockPointer;
  case 35: return CXType_LValueReference;
  case 36: return CXType_RValueReference;
  case 37: return CXType_Record;
  case 38: return CXType_Enum;
  case 39: return CXType_Typedef;
  case 40: return CXType_ObjCInterface;
  case 41: return CXType_ObjCObjectPointer;
  case 42: return CXType_FunctionNoProto;
  case 43: return CXType_FunctionProto;
  case 44: return CXType_ConstantArray;
  case 45: return CXType_Vector;
  case 46: return CXType_IncompleteArray;
  case 47: return CXType_VariableArray;
  case 48: return CXType_DependentSizedArray;
  case 49: return CXType_MemberPointer;
  case 50: return CXType_Auto;
  case 51: return CXType_Elaborated;
  case 52: return CXType_Pipe;
  case 53: return CXType_OCLImage1dRO;
  case 54: return CXType_OCLImage1dArrayRO;
  case 55: return CXType_OCLImage1dBufferRO;
  case 56: return CXType_OCLImage2dRO;
  case 57: return CXType_OCLImage2dArrayRO;
  case 58: return CXType_OCLImage2dDepthRO;
  case 59: return CXType_OCLImage2dArrayDepthRO;
  case 60: return CXType_OCLImage2dMSAARO;
  case 61: return CXType_OCLImage2dArrayMSAARO;
  case 62: return CXType_OCLImage2dMSAADepthRO;
  case 63: return CXType_OCLImage2dArrayMSAADepthRO;
  case 64: return CXType_OCLImage3dRO;
  case 65: return CXType_OCLImage1dWO;
  case 66: return CXType_OCLImage1dArrayWO;
  case 67: return CXType_OCLImage1dBufferWO;
  case 68: return CXType_OCLImage2dWO;
  case 69: return CXType_OCLImage2dArrayWO;
  case 70: return CXType_OCLImage2dDepthWO;
  case 71: return CXType_OCLImage2dArrayDepthWO;
  case 72: return CXType_OCLImage2dMSAAWO;
  case 73: return CXType_OCLImage2dArrayMSAAWO;
  case 74: return CXType_OCLImage2dMSAADepthWO;
  case 75: return CXType_OCLImage2dArrayMSAADepthWO;
  case 76: return CXType_OCLImage3dWO;
  case 77: return CXType_OCLImage1dRW;
  case 78: return CXType_OCLImage1dArrayRW;
  case 79: return CXType_OCLImage1dBufferRW;
  case 80: return CXType_OCLImage2dRW;
  case 81: return CXType_OCLImage2dArrayRW;
  case 82: return CXType_OCLImage2dDepthRW;
  case 83: return CXType_OCLImage2dArrayDepthRW;
  case 84: return CXType_OCLImage2dMSAARW;
  case 85: return CXType_OCLImage2dArrayMSAARW;
  case 86: return CXType_OCLImage2dMSAADepthRW;
  case 87: return CXType_OCLImage2dArrayMSAADepthRW;
  case 88: return CXType_OCLImage3dRW;
  case 89: return CXType_OCLSampler;
  case 90: return CXType_OCLEvent;
  case 91: return CXType_OCLQueue;
  case 92: return CXType_OCLReserveID;
  }
...
Val_cxtypekind(enum CXTypeKind v)
{
  ...
  case CXType_Complex: return Val_int(32);
  case CXType_Pointer: return Val_int(33);
  case CXType_BlockPointer: return Val_int(34);
  case CXType_LValueReference: return Val_int(35);
  case CXType_RValueReference: return Val_int(36);
  case CXType_Record: return Val_int(37);
  case CXType_Enum: return Val_int(38);
  case CXType_Typedef: return Val_int(39);
  case CXType_ObjCInterface: return Val_int(40);
  case CXType_ObjCObjectPointer: return Val_int(41);
  case CXType_FunctionNoProto: return Val_int(42);
  case CXType_FunctionProto: return Val_int(43);
  case CXType_ConstantArray: return Val_int(44);
  case CXType_Vector: return Val_int(45);
  case CXType_IncompleteArray: return Val_int(46);
  case CXType_VariableArray: return Val_int(47);
  case CXType_DependentSizedArray: return Val_int(48);
  case CXType_MemberPointer: return Val_int(49);
  case CXType_Auto: return Val_int(50);
  case CXType_Elaborated: return Val_int(51);
  case CXType_Pipe: return Val_int(52);
  case CXType_OCLImage1dRO: return Val_int(53);
  case CXType_OCLImage1dArrayRO: return Val_int(54);
  case CXType_OCLImage1dBufferRO: return Val_int(55);
  case CXType_OCLImage2dRO: return Val_int(56);
  case CXType_OCLImage2dArrayRO: return Val_int(57);
  case CXType_OCLImage2dDepthRO: return Val_int(58);
  case CXType_OCLImage2dArrayDepthRO: return Val_int(59);
  case CXType_OCLImage2dMSAARO: return Val_int(60);
  case CXType_OCLImage2dArrayMSAARO: return Val_int(61);
  case CXType_OCLImage2dMSAADepthRO: return Val_int(62);
  case CXType_OCLImage2dArrayMSAADepthRO: return Val_int(63);
  case CXType_OCLImage3dRO: return Val_int(64);
  case CXType_OCLImage1dWO: return Val_int(65);
  case CXType_OCLImage1dArrayWO: return Val_int(66);
  case CXType_OCLImage1dBufferWO: return Val_int(67);
  case CXType_OCLImage2dWO: return Val_int(68);
  case CXType_OCLImage2dArrayWO: return Val_int(69);
  case CXType_OCLImage2dDepthWO: return Val_int(70);
  case CXType_OCLImage2dArrayDepthWO: return Val_int(71);
  case CXType_OCLImage2dMSAAWO: return Val_int(72);
  case CXType_OCLImage2dArrayMSAAWO: return Val_int(73);
  case CXType_OCLImage2dMSAADepthWO: return Val_int(74);
  case CXType_OCLImage2dArrayMSAADepthWO: return Val_int(75);
  case CXType_OCLImage3dWO: return Val_int(76);
  case CXType_OCLImage1dRW: return Val_int(77);
  case CXType_OCLImage1dArrayRW: return Val_int(78);
  case CXType_OCLImage1dBufferRW: return Val_int(79);
  case CXType_OCLImage2dRW: return Val_int(80);
  case CXType_OCLImage2dArrayRW: return Val_int(81);
  case CXType_OCLImage2dDepthRW: return Val_int(82);
  case CXType_OCLImage2dArrayDepthRW: return Val_int(83);
  case CXType_OCLImage2dMSAARW: return Val_int(84);
  case CXType_OCLImage2dArrayMSAARW: return Val_int(85);
  case CXType_OCLImage2dMSAADepthRW: return Val_int(86);
  case CXType_OCLImage2dArrayMSAADepthRW: return Val_int(87);
  case CXType_OCLImage3dRW: return Val_int(88);
  case CXType_OCLSampler: return Val_int(89);
  case CXType_OCLEvent: return Val_int(90);
  case CXType_OCLQueue: return Val_int(91);
  case CXType_OCLReserveID: return Val_int(92);
  }
...
clang_getTypeKind_wrapper(value arg)
{
  ...
  enum CXTypeKind result = Cxtype_val(arg).kind;
  {
    CAMLlocal1(data);
...
clang_visitChildren_visitor_callback(CXCursor arg0, CXCursor arg1, CXClientData arg2)
{
  ...
  f = *((value *) arg2);
arg0_ocaml = Val_cxcursor(arg0);arg1_ocaml = Val_cxcursor(arg1);  result = caml_callback2(f, arg0_ocaml, arg1_ocaml);
  {
    CAMLlocal1(data);
...
clang_Cursor_isExternalSymbol_wrapper(value C_ocaml)
{
  ...
  {
    CAMLlocal1(field);
    field = OCAML_OF_CXSTRING(language);
    Store_field(data, 0, field);
  }
  {
    CAMLlocal1(field);
    field = OCAML_OF_CXSTRING(definedIn);
    Store_field(data, 1, field);
  }
  {
    CAMLlocal1(field);
...
DECLARE_OPAQUE(CXToken, cxtoken, Cxtoken_val, Val_cxtoken)
...
CAMLprim value
clang_annotateTokens_wrapper(value TU_ocaml, value Tokens_ocaml, value NumTokens_ocaml, value Cursors_ocaml)
{
  CAMLparam4(TU_ocaml, Tokens_ocaml, NumTokens_ocaml, Cursors_ocaml);
  CXTranslationUnit TU;
  TU = Cxtranslationunit_val(TU_ocaml);
  CXToken * Tokens;
  Tokens = (Tokens_ocaml);
  unsigned int NumTokens;
  NumTokens = Int_val(NumTokens_ocaml);
  CXCursor * Cursors;
  Cursors = (Cursors_ocaml);
...
CAMLprim value
clang_codeCompleteAt_wrapper(value TU_ocaml, value complete_filename_ocaml, value complete_line_ocaml, value complete_column_ocaml, value unsaved_files_ocaml, value options_ocaml)
{
  CAMLparam5(TU_ocaml, complete_filename_ocaml, complete_line_ocaml, complete_column_ocaml, unsaved_files_ocaml);
  CAMLxparam1(options_ocaml);
  CXTranslationUnit TU;
  TU = Cxtranslationunit_val(TU_ocaml);
  const char * complete_filename;
  complete_filename = String_val(complete_filename_ocaml);
  unsigned int complete_line;
  complete_line = Int_val(complete_line_ocaml);
  unsigned int complete_column;
  complete_column = Int_val(complete_column_ocaml);
  unsigned int num_unsaved_files = Wosize_val(unsaved_files_ocaml);
  struct CXUnsavedFile * unsaved_files = xmalloc(num_unsaved_files * sizeof(struct CXUnsavedFile));
  unsigned int i; for (i = 0; i < num_unsaved_files; i++) {
    unsaved_files[i] = Cxunsavedfile_val(Field(unsaved_files_ocaml, i));
  ...
  unsigned int options;
  options = Int_val(options_ocaml);
  CXCodeCompleteResults * result = clang_codeCompleteAt(TU, complete_filename, complete_line, complete_column, (struct CXUnsavedFile *) unsaved_files, num_unsaved_files, options);
  {
    CAMLlocal1(data);
    data = (result);
    CAMLreturn(data);
...
CAMLprim value
clang_codeCompleteAt_bytecode(value *argv, int argn)
{
  return clang_codeCompleteAt_wrapper(argv[0], argv[1], argv[2], argv[3], argv[4], argv[5]);}

CAMLprim value
clang_sortCodeCompletionResults_wrapper(value Results_ocaml, value NumResults_ocaml)
{
  CAMLparam2(Results_ocaml, NumResults_ocaml);
  CXCompletionResult * Results;
  Results = (Results_ocaml);
  unsigned int NumResults;
  NumResults = Int_val(NumResults_ocaml);
  clang_sortCodeCompletionResults(Results, NumResults);
  CAMLreturn(Val_unit);
}

CAMLprim value
clang_disposeCodeCompleteResults_wrapper(value Results_ocaml)
{
  CAMLparam1(Results_ocaml);
...
CAMLprim value
clang_codeCompleteGetNumDiagnostics_wrapper(value Results_ocaml)
{
  CAMLparam1(Results_ocaml);
  CXCodeCompleteResults * Results;
  Results = (Results_ocaml);
  unsigned int result = clang_codeCompleteGetNumDiagnostics(Results);
  {
    CAMLlocal1(data);
    data = Val_int(result);
    CAMLreturn(data);
...
CAMLprim value
clang_codeCompleteGetDiagnostic_wrapper(value Results_ocaml, value Index_ocaml)
{
  CAMLparam2(Results_ocaml, Index_ocaml);
  CXCodeCompleteResults * Results;
  Results = (Results_ocaml);
  unsigned int Index;
  Index = Int_val(Index_ocaml);
...
CAMLprim value
clang_codeCompleteGetContexts_wrapper(value Results_ocaml)
{
  CAMLparam1(Results_ocaml);
  CXCodeCompleteResults * Results;
  Results = (Results_ocaml);
  unsigned long long result = clang_codeCompleteGetContexts(Results);
  {
    CAMLlocal1(data);
    data = Val_int(result);
    CAMLreturn(data);
...
CAMLprim value
clang_codeCompleteGetContainerKind_wrapper(value Results_ocaml, value IsIncomplete_ocaml)
{
  CAMLparam2(Results_ocaml, IsIncomplete_ocaml);
  CXCodeCompleteResults * Results;
  Results = (Results_ocaml);
  unsigned int * IsIncomplete;
  IsIncomplete = (IsIncomplete_ocaml);
  enum CXCursorKind result = clang_codeCompleteGetContainerKind(Results, IsIncomplete);
  {
    CAMLlocal1(data);
    data = Val_cxcursorkind(result);
    CAMLreturn(data);
...
CAMLprim value
clang_codeCompleteGetContainerUSR_wrapper(value Results_ocaml)
{
  CAMLparam1(Results_ocaml);
  CXCodeCompleteResults * Results;
  Results = (Results_ocaml);
...
CAMLprim value
clang_codeCompleteGetObjCSelector_wrapper(value Results_ocaml)
{
  CAMLparam1(Results_ocaml);
  CXCodeCompleteResults * Results;
  Results = (Results_ocaml);
...
void
clang_getInclusions_visitor_callback(CXFile arg0, CXSourceLocation * arg1, unsigned int arg2, CXClientData arg3)
{
  CAMLparam0();
  CAMLlocal5(result, f, arg0_ocaml, arg1_ocaml, arg2_ocaml);
  f = *((value *) arg3);
arg0_ocaml = Val_cxfile(arg0);arg1_ocaml = (arg1);arg2_ocaml = Val_int(arg2);  caml_callback3(f, arg0_ocaml, arg1_ocaml, arg2_ocaml);
}

CAMLprim value
clang_getInclusions_wrapper(value tu_ocaml, value visitor_ocaml)
{
  CAMLparam2(tu_ocaml, visitor_ocaml);
  CXTranslationUnit tu;
  tu = Cxtranslationunit_val(tu_ocaml);
  clang_getInclusions(tu, clang_getInclusions_visitor_callback, &visitor_ocaml);
  CAMLreturn(Val_unit);
}
...
CAMLprim value
clang_remap_getFilenames_wrapper(value arg_ocaml, value index_ocaml, value original_ocaml, value transformed_ocaml)
{
  CAMLparam4(arg_ocaml, index_ocaml, original_ocaml, transformed_ocaml);
  CXRemapping arg;
  arg = Cxremapping_val(arg_ocaml);
  unsigned int index;
  index = Int_val(index_ocaml);
  CXString * original;
  original = (original_ocaml);
  CXString * transformed;
  transformed = (transformed_ocaml);
  clang_remap_getFilenames(arg, index, original, transformed);
  CAMLreturn(Val_unit);
}
...
CXResult
Cxresult_val(value ocaml)
{
  switch (Int_val(ocaml)) {
  case 0: return CXResult_Success;
  case 1: return CXResult_Invalid;
  case 2: return CXResult_VisitBreak;
  }
  failwith_fmt("invalid value for Cxresult_val: %d", Int_val(ocaml));
  return CXResult_Success;
}

value
Val_cxresult(CXResult v)
{
  switch (v) {
  case CXResult_Success: return Val_int(0);
  case CXResult_Invalid: return Val_int(1);
  case CXResult_VisitBreak: return Val_int(2);
  }
  failwith_fmt("invalid value for Val_cxresult: %d", v);
  return Val_int(0);
}

DECLARE_OPAQUE(struct CXCursorAndRangeVisitor, cxcursorandrangevisitor, Cxcursorandrangevisitor_val, Val_cxcursorandrangevisitor)

CAMLprim value
clang_findReferencesInFile_wrapper(value cursor_ocaml, value file_ocaml, value visitor_ocaml)
{
  CAMLparam3(cursor_ocaml, file_ocaml, visitor_ocaml);
  CXCursor cursor;
  cursor = Cxcursor_val(cursor_ocaml);
  CXFile file;
  file = Cxfile_val(file_ocaml);
  CXCursorAndRangeVisitor visitor;
  visitor = Cxcursorandrangevisitor_val(visitor_ocaml);
  CXResult result = clang_findReferencesInFile(cursor, file, visitor);
  {
    CAMLlocal1(data);
    data = Val_cxresult(result);
    CAMLreturn(data);
  }
}

CAMLprim value
clang_findIncludesInFile_wrapper(value TU_ocaml, value file_ocaml, value visitor_ocaml)
{
  CAMLparam3(TU_ocaml, file_ocaml, visitor_ocaml);
  CXTranslationUnit TU;
  TU = Cxtranslationunit_val(TU_ocaml);
  CXFile file;
  file = Cxfile_val(file_ocaml);
...
CXIdxEntityKind
Cxidxentitykind_val(value ocaml)
{
  switch (Int_val(ocaml)) {
  case 0: return CXIdxEntity_Unexposed;
  case 1: return CXIdxEntity_Typedef;
  case 2: return CXIdxEntity_Function;
  case 3: return CXIdxEntity_Variable;
  case 4: return CXIdxEntity_Field;
  case 5: return CXIdxEntity_EnumConstant;
  case 6: return CXIdxEntity_ObjCClass;
  case 7: return CXIdxEntity_ObjCProtocol;
  case 8: return CXIdxEntity_ObjCCategory;
  case 9: return CXIdxEntity_ObjCInstanceMethod;
  case 10: return CXIdxEntity_ObjCClassMethod;
  case 11: return CXIdxEntity_ObjCProperty;
  case 12: return CXIdxEntity_ObjCIvar;
  case 13: return CXIdxEntity_Enum;
  case 14: return CXIdxEntity_Struct;
  case 15: return CXIdxEntity_Union;
  case 16: return CXIdxEntity_CXXClass;
  case 17: return CXIdxEntity_CXXNamespace;
  case 18: return CXIdxEntity_CXXNamespaceAlias;
  case 19: return CXIdxEntity_CXXStaticVariable;
  case 20: return CXIdxEntity_CXXStaticMethod;
  case 21: return CXIdxEntity_CXXInstanceMethod;
  case 22: return CXIdxEntity_CXXConstructor;
  case 23: return CXIdxEntity_CXXDestructor;
  case 24: return CXIdxEntity_CXXConversionFunction;
  case 25: return CXIdxEntity_CXXTypeAlias;
  case 26: return CXIdxEntity_CXXInterface;
  }
  failwith_fmt("invalid value for Cxidxentitykind_val: %d", Int_val(ocaml));
  return CXIdxEntity_Unexposed;
}

value
Val_cxidxentitykind(CXIdxEntityKind v)
{
  switch (v) {
  case CXIdxEntity_Unexposed: return Val_int(0);
  case CXIdxEntity_Typedef: return Val_int(1);
  case CXIdxEntity_Function: return Val_int(2);
  case CXIdxEntity_Variable: return Val_int(3);
  case CXIdxEntity_Field: return Val_int(4);
  case CXIdxEntity_EnumConstant: return Val_int(5);
  case CXIdxEntity_ObjCClass: return Val_int(6);
  case CXIdxEntity_ObjCProtocol: return Val_int(7);
  case CXIdxEntity_ObjCCategory: return Val_int(8);
  case CXIdxEntity_ObjCInstanceMethod: return Val_int(9);
  case CXIdxEntity_ObjCClassMethod: return Val_int(10);
  case CXIdxEntity_ObjCProperty: return Val_int(11);
  case CXIdxEntity_ObjCIvar: return Val_int(12);
  case CXIdxEntity_Enum: return Val_int(13);
  case CXIdxEntity_Struct: return Val_int(14);
  case CXIdxEntity_Union: return Val_int(15);
  case CXIdxEntity_CXXClass: return Val_int(16);
  case CXIdxEntity_CXXNamespace: return Val_int(17);
  case CXIdxEntity_CXXNamespaceAlias: return Val_int(18);
  case CXIdxEntity_CXXStaticVariable: return Val_int(19);
  case CXIdxEntity_CXXStaticMethod: return Val_int(20);
  case CXIdxEntity_CXXInstanceMethod: return Val_int(21);
  case CXIdxEntity_CXXConstructor: return Val_int(22);
  case CXIdxEntity_CXXDestructor: return Val_int(23);
  case CXIdxEntity_CXXConversionFunction: return Val_int(24);
  case CXIdxEntity_CXXTypeAlias: return Val_int(25);
  case CXIdxEntity_CXXInterface: return Val_int(26);
  }
  failwith_fmt("invalid value for Val_cxidxentitykind: %d", v);
  return Val_int(0);
}

CAMLprim value
clang_index_isEntityObjCContainerKind_wrapper(value arg_ocaml)
{
  CAMLparam1(arg_ocaml);
  CXIdxEntityKind arg;
  arg = Cxidxentitykind_val(arg_ocaml);
  int result = clang_index_isEntityObjCContainerKind(arg);
  if (result) {
    CAMLlocal2(ocaml_result, data);
    ocaml_result = caml_alloc(1, 0);
    data = Val_unit;
...
CAMLprim value
clang_index_getObjCContainerDeclInfo_wrapper(value arg_ocaml)
{
  CAMLparam1(arg_ocaml);
  const CXIdxDeclInfo * arg;
  arg = (arg_ocaml);
  const CXIdxObjCContainerDeclInfo * result = clang_index_getObjCContainerDeclInfo(arg);
  {
    CAMLlocal1(data);
    data = (result);
    CAMLreturn(data);
...
CAMLprim value
clang_index_getObjCInterfaceDeclInfo_wrapper(value arg_ocaml)
{
  CAMLparam1(arg_ocaml);
  const CXIdxDeclInfo * arg;
  arg = (arg_ocaml);
  const CXIdxObjCInterfaceDeclInfo * result = clang_index_getObjCInterfaceDeclInfo(arg);
  {
    CAMLlocal1(data);
    data = (result);
    CAMLreturn(data);
...
CAMLprim value
clang_index_getObjCCategoryDeclInfo_wrapper(value arg_ocaml)
{
  CAMLparam1(arg_ocaml);
  const CXIdxDeclInfo * arg;
  arg = (arg_ocaml);
  const CXIdxObjCCategoryDeclInfo * result = clang_index_getObjCCategoryDeclInfo(arg);
  {
    CAMLlocal1(data);
    data = (result);
    CAMLreturn(data);
...
CAMLprim value
clang_index_getObjCProtocolRefListInfo_wrapper(value arg_ocaml)
{
  CAMLparam1(arg_ocaml);
  const CXIdxDeclInfo * arg;
  arg = (arg_ocaml);
  const CXIdxObjCProtocolRefListInfo * result = clang_index_getObjCProtocolRefListInfo(arg);
  {
    CAMLlocal1(data);
    data = (result);
    CAMLreturn(data);
...
CAMLprim value
clang_index_getObjCPropertyDeclInfo_wrapper(value arg_ocaml)
{
  CAMLparam1(arg_ocaml);
  const CXIdxDeclInfo * arg;
  arg = (arg_ocaml);
  const CXIdxObjCPropertyDeclInfo * result = clang_index_getObjCPropertyDeclInfo(arg);
  {
    CAMLlocal1(data);
    data = (result);
    CAMLreturn(data);
...
CAMLprim value
clang_index_getIBOutletCollectionAttrInfo_wrapper(value arg_ocaml)
{
  CAMLparam1(arg_ocaml);
  const CXIdxAttrInfo * arg;
  arg = (arg_ocaml);
  const CXIdxIBOutletCollectionAttrInfo * result = clang_index_getIBOutletCollectionAttrInfo(arg);
  {
    CAMLlocal1(data);
    data = (result);
    CAMLreturn(data);
...
CAMLprim value
clang_index_getCXXClassDeclInfo_wrapper(value arg_ocaml)
{
  CAMLparam1(arg_ocaml);
  const CXIdxDeclInfo * arg;
  arg = (arg_ocaml);
  const CXIdxCXXClassDeclInfo * result = clang_index_getCXXClassDeclInfo(arg);
  {
    CAMLlocal1(data);
    data = (result);
    CAMLreturn(data);
...
DECLARE_OPAQUE(CXIdxClientContainer, cxidxclientcontainer, Cxidxclientcontainer_val, Val_cxidxclientcontainer)

CAMLprim value
clang_index_getClientContainer_wrapper(value arg_ocaml)
{
  CAMLparam1(arg_ocaml);
  const CXIdxContainerInfo * arg;
  arg = (arg_ocaml);
  CXIdxClientContainer result = clang_index_getClientContainer(arg);
  {
    CAMLlocal1(data);
    data = Val_cxidxclientcontainer(result);
    CAMLreturn(data);
  }
}

CAMLprim value
clang_index_setClientContainer_wrapper(value arg_ocaml, value arg2_ocaml)
{
  CAMLparam2(arg_ocaml, arg2_ocaml);
  const CXIdxContainerInfo * arg;
  arg = (arg_ocaml);
  CXIdxClientContainer arg2;
  arg2 = Cxidxclientcontainer_val(arg2_ocaml);
  clang_index_setClientContainer(arg, arg2);
  CAMLreturn(Val_unit);
}

DECLARE_OPAQUE(CXIdxClientEntity, cxidxcliententity, Cxidxcliententity_val, Val_cxidxcliententity)

CAMLprim value
clang_index_getClientEntity_wrapper(value arg_ocaml)
{
  CAMLparam1(arg_ocaml);
  const CXIdxEntityInfo * arg;
  arg = (arg_ocaml);
  CXIdxClientEntity result = clang_index_getClientEntity(arg);
  {
    CAMLlocal1(data);
    data = Val_cxidxcliententity(result);
    CAMLreturn(data);
  }
}

CAMLprim value
clang_index_setClientEntity_wrapper(value arg_ocaml, value arg2_ocaml)
{
  CAMLparam2(arg_ocaml, arg2_ocaml);
  const CXIdxEntityInfo * arg;
  arg = (arg_ocaml);
  CXIdxClientEntity arg2;
  arg2 = Cxidxcliententity_val(arg2_ocaml);
  clang_index_setClientEntity(arg, arg2);
  CAMLreturn(Val_unit);
}
...
DECLARE_OPAQUE(CXClientData, cxclientdata, Cxclientdata_val, Val_cxclientdata)

CAMLprim value
clang_indexSourceFile_wrapper(value arg_ocaml, value client_data_ocaml, value index_callbacks_ocaml, value index_callbacks_size_ocaml, value index_options_ocaml, value source_filename_ocaml, value command_line_args_ocaml, value unsaved_files_ocaml, value TU_options_ocaml)
{
  CAMLparam5(arg_ocaml, client_data_ocaml, index_callbacks_ocaml, index_callbacks_size_ocaml, index_options_ocaml);
  CAMLxparam4(source_filename_ocaml, command_line_args_ocaml, unsaved_files_ocaml, TU_options_ocaml);
  CXIndexAction arg;
  arg = Cxindexaction_val(arg_ocaml);
  CXClientData client_data;
  client_data = Cxclientdata_val(client_data_ocaml);
  IndexerCallbacks * index_callbacks;
  index_callbacks = (index_callbacks_ocaml);
  unsigned int index_callbacks_size;
  index_callbacks_size = Int_val(index_callbacks_size_ocaml);
  unsigned int index_options;
  index_options = Int_val(index_options_ocaml);
  const char * source_filename;
  source_filename = String_val(source_filename_ocaml);
  int num_command_line_args = Wosize_val(command_line_args_ocaml);
   char * * command_line_args = xmalloc(num_command_line_args * sizeof(const char *const));
  ...
  TU_options = Int_val(TU_options_ocaml);
  int result = clang_indexSourceFile(arg, client_data, index_callbacks, index_callbacks_size, index_options, source_filename, (const char *const *) command_line_args, num_command_line_args, (struct CXUnsavedFile *) unsaved_files, num_unsaved_files, &out_TU, TU_options);
  if (result == CXError_Success) {
    CAMLlocal2(ocaml_result, data);
    ocaml_result = caml_alloc(1, 0);
    data = Val_cxtranslationunit(out_TU);
...
CAMLprim value
clang_indexSourceFile_bytecode(value *argv, int argn)
{
  return clang_indexSourceFile_wrapper(argv[0], argv[1], argv[2], argv[3], argv[4], argv[5], argv[6], argv[7], argv[8]);}

CAMLprim value
clang_indexSourceFileFullArgv_wrapper(value arg_ocaml, value client_data_ocaml, value index_callbacks_ocaml, value index_callbacks_size_ocaml, value index_options_ocaml, value source_filename_ocaml, value command_line_args_ocaml, value unsaved_files_ocaml, value TU_options_ocaml)
{
  CAMLparam5(arg_ocaml, client_data_ocaml, index_callbacks_ocaml, index_callbacks_size_ocaml, index_options_ocaml);
  CAMLxparam4(source_filename_ocaml, command_line_args_ocaml, unsaved_files_ocaml, TU_options_ocaml);
  CXIndexAction arg;
  ...
  unsigned int TU_options;
  TU_options = Int_val(TU_options_ocaml);
  int result = clang_indexSourceFileFullArgv(arg, client_data, index_callbacks, index_callbacks_size, index_options, source_filename, (const char *const *) command_line_args, num_command_line_args, (struct CXUnsavedFile *) unsaved_files, num_unsaved_files, &out_TU, TU_options);
  if (result == CXError_Success) {
    CAMLlocal2(ocaml_result, data);
    ocaml_result = caml_alloc(1, 0);
    data = Val_cxtranslationunit(out_TU);
...
CAMLprim value
clang_indexSourceFileFullArgv_bytecode(value *argv, int argn)
{
  return clang_indexSourceFileFullArgv_wrapper(argv[0], argv[1], argv[2], argv[3], argv[4], argv[5], argv[6], argv[7], argv[8]);}

CAMLprim value
clang_indexTranslationUnit_wrapper(value arg_ocaml, value client_data_ocaml, value index_callbacks_ocaml, value index_callbacks_size_ocaml, value index_options_ocaml, value arg2_ocaml)
{
  CAMLparam5(arg_ocaml, client_data_ocaml, index_callbacks_ocaml, index_callbacks_size_ocaml, index_options_ocaml);
  CAMLxparam1(arg2_ocaml);
  CXIndexAction arg;
  arg = Cxindexaction_val(arg_ocaml);
  CXClientData client_data;
  client_data = Cxclientdata_val(client_data_ocaml);
  ...
  unsigned int index_options;
  index_options = Int_val(index_options_ocaml);
  CXTranslationUnit arg2;
  arg2 = Cxtranslationunit_val(arg2_ocaml);
  int result = clang_indexTranslationUnit(arg, client_data, index_callbacks, index_callbacks_size, index_options, arg2);
  {
    CAMLlocal1(data);
    data = Val_int(result);
    CAMLreturn(data);
...
CAMLprim value
clang_indexTranslationUnit_bytecode(value *argv, int argn)
{
  return clang_indexTranslationUnit_wrapper(argv[0], argv[1], argv[2], argv[3], argv[4], argv[5]);}

DECLARE_OPAQUE(CXIdxClientFile, cxidxclientfile, Cxidxclientfile_val, Val_cxidxclientfile)

DECLARE_OPAQUE(CXIdxLoc, cxidxloc, Cxidxloc_val, Val_cxidxloc)

CAMLprim value
clang_indexLoc_getFileLocation_wrapper(value loc_ocaml)
{
  CAMLparam1(loc_ocaml);
  CXIdxLoc loc;
  loc = Cxidxloc_val(loc_ocaml);
  ...
  {
    CAMLlocal1(field);
    field = Val_cxidxclientfile(indexFile);
    Store_field(data, 4, field);
  }
...
CAMLprim value
clang_indexLoc_getCXSourceLocation_wrapper(value loc_ocaml)
{
  CAMLparam1(loc_ocaml);
  CXIdxLoc loc;
  loc = Cxidxloc_val(loc_ocaml);
...
clang_Type_visitFields_visitor_callback(CXCursor arg0, CXClientData arg1)
{
  ...
  f = *((value *) arg1);
arg0_ocaml = Val_cxcursor(arg0);  result = caml_callback(f, arg0_ocaml);
  {
    CAMLlocal1(data);
